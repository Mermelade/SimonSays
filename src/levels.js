...
levels.prototype = {
	...
	createButtons: function () {
		...
		easyButton = this.game.add.button(this.game.world.centerX*0.25,this.game.world.centerY*1.83,"button",this.previousPage,this,1,0,2,0);
		easyButton.anchor.setTo(0.5,0.5);
		easyButton.scale.set(0.75);
		hardButton = this.game.add.button(this.game.world.centerX*1.75,this.game.world.centerY*1.83,"button",this.nextPage,this,1,0,2,0);
		hardButton.anchor.setTo(0.5,0.5);
		hardButton.scale.set(0.75);
	},

	showButtons: function () {
		if (page[pageNumber] == "Easy") easyButton.visible = false;
		else if (page[pageNumber] == "Hard") hardButton.visible = false;
		else {
	...
	nextPage: function () {
		if (pageNumber<2) {
			pageNumber++;
			//actualizamos el levelTitleText
