...
preload.prototype = {
	preload: function(){ 
		...
		//this.game.load.image("dunes","assets/Dunes1.png");
		...
		//this.game.load.image("dunes1","assets/Dunes_1.png");
		//this.game.load.image("dunes2","assets/Dunes_2.png");
		//this.game.load.image("dunes3","assets/Dunes_3.png");
		//this.game.load.image("dunes4","assets/Dunes_4.png");
